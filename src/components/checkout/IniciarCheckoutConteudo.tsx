...
import { iniciarCheckoutPixConteudo, type CheckoutPixResultado } from "@/app/(public)/checkout/actions";
import { formatarPreco } from "@/lib/catalogo";
import CheckoutPix from "./CheckoutPix";

export default function IniciarCheckoutConteudo({
  cdConteudo,
  tipo,
  titulo,
  valor,
  ...
  useEffect(() => {
    let cancelado = false;
    iniciarCheckoutPixConteudo(cdConteudo, tipo)
      .then((r) => {
