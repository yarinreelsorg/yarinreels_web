...
export default function InstallPwaButton() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-[100px] z-[90] flex items-center justify-between gap-3 rounded-xl border border-primary/40 bg-surface p-3.5 shadow-[0_10px_30px_rgba(0,0,0,0.5)] sm:inset-x-auto sm:right-6 sm:w-80 lg:bottom-6">
